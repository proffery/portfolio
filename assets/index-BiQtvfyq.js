 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _1=j,P1=Symbol.for("react.element"),C1=Symbol.for("react.fragment"),E1=Object.prototype.hasOwnProperty,I1=_1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,T1={key:!0,ref:!0,__self:!0,__source:!0};function tg(e,t,n){var i,r={},o=null,s=null;n!==void 0&&(o=""+n),t.key!==void 0&&(o=""+t.key),t.ref!==void 0&&(s=t.ref);for(i in t)E1.call(t,i)&&!T1.hasOwnProperty(i)&&(r[i]=t[i]);if(e&&e.defaultProps)for(i in t=e.defaultProps,t)r[i]===void 0&&(r[i]=t[i]);return{$$typeof:P1,type:e,key:o,ref:s,props:r,_owner:I1.current}}Ja.Fragment=C1;Ja.jsx=tg;Ja.jsxs=tg;Vm.exports=Ja;var _=Vm.exports,su={},ng={exports:{}},Et={},ig={exports:{}},rg={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(T,F){var U=T.length;T.push(F);e:for(;0<U;){var Q=U-1>>>1,Z=T[Q];if(0<r(Z,F))T[Q]=F,T[U]=Z,U=Q;else break e}}function n(T){return T.length===0?null:T[0]}function i(T){if(T.length===0)return null;var F=T[0],U=T.pop();if(U!==F){T[0]=U;e:for(var Q=0,Z=T.length,et=Z>>>1;Q<et;){var ae=2*(Q+1)-1,Rn=T[ae],mt=ae+1,xn=T[mt];if(0>r(Rn,U))mt<Z&&0>r(xn,Rn)?(T[Q]=xn,T[mt]=U,Q=mt):(T[Q]=Rn,T[ae]=U,Q=ae);else if(mt<Z&&0>r(xn,U))T[Q]=xn,T[mt]=U,Q=mt;else break e}}return F}function r(T,F){var U=T.sortIndex-F.sortIndex;return U!==0?U:T.id-F.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var s=Date,a=s.now();e.unstable_now=function(){return s.now()-a}}var l=[],c=[],u=1,h=null,f=3,y=!1,v=!1,m=!1,P=typeof setTimeout=="function"?setTimeout:null,w=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d(T){for(var F=n(c);F!==null;){if(F.callback===null)i(c);else if(F.startTime<=T)i(c),F.sortIndex=F.expirationTime,t(l,F);else break;F=n(c)}}function p(T){if(m=!1,d(T),!v)if(n(l)!==null)v=!0,B(x);else{var F=n(c);F!==null&&H(p,F.startTime-T)}}function x(T,F){v=!1,m&&(m=!1,w(C),C=-1),y=!0;var U=f;try{for(d(F),h=n(l);h!==null&&(!(h.expirationTime>F)||T&&!A());){var Q=h.callback;if(typeof Q=="function"){h.callback=null,f=h.priorityLevel;var Z=Q(h.expirationTime<=F);F=e.unstable_now(),typeof Z=="function"?h.callback=Z:h===n(l)&&i(l),d(F)}else i(l);h=n(l)}if(h!==null)var et=!0;else{var ae=n(c);ae!==null&&H(p,ae.startTime-F),et=!1}return et}finally{h=null,f=U,y=!1}}var S=!1,k=null,C=-1,I=5,M=-1;function A(){return!(e.unstable_now()-M<I)}function E(){if(k!==null){var T=e.unstable_now();M=T;var F=!0;try{F=k(!0,T)}finally{F?D():(S=!1,k=null)}}else S=!1}var D;if(typeof g=="function")D=function(){g(E)};else if(typeof MessageChannel<"u"){var O=new MessageChannel,L=O.port2;O.port1.onmessage=E,D=function(){L.postMessage(null)}}else D=function(){P(E,0)};function B(T){k=T,S||(S=!0,D())}function H(T,F){C=P(function(){T(e.unstable_now())},F)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(T){T.callback=null},e.unstable_continueExecution=function(){v||y||(v=!0,B(x))},e.unstable_forceFrameRate=function(T){0>T||125<T?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):I=0<T?Math.floor(1e3/T):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(l)},e.unstable_next=function(T){switch(f){case 1:case 2:case 3:var F=3;break;default:F=f}var U=f;f=F;try{return T()}finally{f=U}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(T,F){switch(T){case 1:case 2:case 3:case 4:case 5:break;default:T=3}var U=f;f=T;try{return F()}finally{f=U}},e.unstable_scheduleCallback=function(T,F,U){var Q=e.unstable_now();switch(typeof U=="object"&&U!==null?(U=U.delay,U=typeof U=="number"&&0<U?Q+U:Q):U=Q,T){case 1:var Z=-1;break;case 2:Z=250;break;case 5:Z=1073741823;break;case 4:Z=1e4;break;default:Z=5e3}return Z=U+Z,T={id:u++,callback:F,priorityLevel:T,startTime:U,expirationTime:Z,sortIndex:-1},U>Q?(T.sortIndex=U,t(c,T),n(l)===null&&T===n(c)&&(m?(w(C),C=-1):m=!0,H(p,U-Q))):(T.sortIndex=Z,t(l,T),v||y||(v=!0,B(x))),T},e.unstable_shouldYield=A,e.unstable_wrapCallback=function(T){var F=f;return function(){var U=f;f=F;try{return T.apply(this,arguments)}finally{f=U}}}})(rg);ig.exports=rg;var M1=ig.exports;/**
 * @license React
...
`,co={Header:ZE,HeaderContainer:JE,Left:eI,Right:tI,TopButton:nI};var iI=!1;function rI(e){if(e.sheet)return e.sheet;for(var t=0;t<document.styleSheets.length;t++)if(document.styleSheets[t].ownerNode===e)return document.styleSheets[t]}function oI(e){var t=document.createElement("style");return t.setAttribute("data-emotion",e.key),e.nonce!==void 0&&t.setAttribute("nonce",e.nonce),t.appendChild(document.createTextNode("")),t.setAttribute("data-s",""),t}var sI=function(){function e(n){var i=this;this._insertTag=function(r){var o;i.tags.length===0?i.insertionPoint?o=i.insertionPoint.nextSibling:i.prepend?o=i.container.firstChild:o=i.before:o=i.tags[i.tags.length-1].nextSibling,i.container.insertBefore(r,o),i.tags.push(r)},this.isSpeedy=n.speedy===void 0?!iI:n.speedy,this.tags=[],this.ctr=0,this.nonce=n.nonce,this.key=n.key,this.container=n.container,this.prepend=n.prepend,this.insertionPoint=n.insertionPoint,this.before=null}var t=e.prototype;return t.hydrate=function(i){i.forEach(this._insertTag)},t.insert=function(i){this.ctr%(this.isSpeedy?65e3:1)===0&&this._insertTag(oI(this));var r=this.tags[this.tags.length-1];if(this.isSpeedy){var o=rI(r);try{o.insertRule(i,o.cssRules.length)}catch{}}else r.appendChild(document.createTextNode(i));this.ctr++},t.flush=function(){this.tags.forEach(function(i){var r;return(r=i.parentNode)==null?void 0:r.removeChild(i)}),this.tags=[],this.ctr=0},e}(),Xe="-ms-",Za="-moz-",ee="-webkit-",lv="comm",Lf="rule",jf="decl",aI="@import",cv="@keyframes",lI="@layer",cI=Math.abs,Cl=String.fromCharCode,uI=Object.assign;function dI(e,t){return Fe(e,0)^45?(((t<<2^Fe(e,0))<<2^Fe(e,1))<<2^Fe(e,2))<<2^Fe(e,3):0}function uv(e){return e.trim()}function fI(e,t){return(e=t.exec(e))?e[0]:e}function te(e,t,n){return e.replace(t,n)}function gd(e,t){return e.indexOf(t)}function Fe(e,t){return e.charCodeAt(t)|0}function es(e,t,n){return e.slice(t,n)}function dn(e){return e.length}function Nf(e){return e.length}function Ys(e,t){return t.push(e),e}function hI(e,t){return e.map(t).join("")}var El=1,Wr=1,dv=0,pt=0,Ee=0,qr="";function Il(e,t,n,i,r,o,s){return{value:e,root:t,parent:n,type:i,props:r,children:o,line:El,column:Wr,length:s,return:""}}function uo(e,t){return uI(Il("",null,null,"",null,null,0),e,{length:-e.length},t)}function pI(){return Ee}function mI(){return Ee=pt>0?Fe(qr,--pt):0,Wr--,Ee===10&&(Wr=1,El--),Ee}function Pt(){return Ee=pt<dv?Fe(qr,pt++):0,Wr++,Ee===10&&(Wr=1,El++),Ee}function gn(){return Fe(qr,pt)}function va(){return pt}function us(e,t){return es(qr,e,t)}function ts(e){switch(e){case 0:case 9:case 10:case 13:case 32:return 5;case 33:case 43:case 44:case 47:case 62:case 64:case 126:case 59:case 123:case 125:return 4;case 58:return 3;case 34:case 39:case 40:case 91:return 2;case 41:case 93:return 1}return 0}function fv(e){return El=Wr=1,dv=dn(qr=e),pt=0,[]}function hv(e){return qr="",e}function wa(e){return uv(us(pt-1,yd(e===91?e+2:e===40?e+1:e)))}function gI(e){for(;(Ee=gn())&&Ee<33;)Pt();return ts(e)>2||ts(Ee)>3?"":" "}function yI(e,t){for(;--t&&Pt()&&!(Ee<48||Ee>102||Ee>57&&Ee<65||Ee>70&&Ee<97););return us(e,va()+(t<6&&gn()==32&&Pt()==32))}function yd(e){for(;Pt();)switch(Ee){case e:return pt;case 34:case 39:e!==34&&e!==39&&yd(Ee);break;case 40:e===41&&yd(e);break;case 92:Pt();break}return pt}function vI(e,t){for(;Pt()&&e+Ee!==57;)if(e+Ee===84&&gn()===47)break;return"/*"+us(t,pt-1)+"*"+Cl(e===47?e:Pt())}function wI(e){for(;!ts(gn());)Pt();return us(e,pt)}function xI(e){return hv(xa("",null,null,null,[""],e=fv(e),0,[0],e))}function xa(e,t,n,i,r,o,s,a,l){for(var c=0,u=0,h=s,f=0,y=0,v=0,m=1,P=1,w=1,g=0,d="",p=r,x=o,S=i,k=d;P;)switch(v=g,g=Pt()){case 40:if(v!=108&&Fe(k,h-1)==58){gd(k+=te(wa(g),"&","&\f"),"&\f")!=-1&&(w=-1);break}case 34:case 39:case 91:k+=wa(g);break;case 9:case 10:case 13:case 32:k+=gI(v);break;case 92:k+=yI(va()-1,7);continue;case 47:switch(gn()){case 42:case 47:Ys(bI(vI(Pt(),va()),t,n),l);break;default:k+="/"}break;case 123*m:a[c++]=dn(k)*w;case 125*m:case 59:case 0:switch(g){case 0:case 125:P=0;case 59+u:w==-1&&(k=te(k,/\f/g,"")),y>0&&dn(k)-h&&Ys(y>32?Cm(k+";",i,n,h-1):Cm(te(k," ","")+";",i,n,h-2),l);break;case 59:k+=";";default:if(Ys(S=Pm(k,t,n,c,u,r,a,d,p=[],x=[],h),o),g===123)if(u===0)xa(k,t,S,S,p,o,h,a,x);else switch(f===99&&Fe(k,3)===110?100:f){case 100:case 108:case 109:case 115:xa(e,S,S,i&&Ys(Pm(e,S,S,0,0,r,a,d,r,p=[],h),x),r,x,h,a,i?p:x);break;default:xa(k,S,S,S,[""],x,0,a,x)}}c=u=y=0,m=w=1,d=k="",h=s;break;case 58:h=1+dn(k),y=v;default:if(m<1){if(g==123)--m;else if(g==125&&m++==0&&mI()==125)continue}switch(k+=Cl(g),g*m){case 38:w=u>0?1:(k+="\f",-1);break;case 44:a[c++]=(dn(k)-1)*w,w=1;break;case 64:gn()===45&&(k+=wa(Pt())),f=gn(),u=h=dn(d=k+=wI(va())),g++;break;case 45:v===45&&dn(k)==2&&(m=0)}}return o}function Pm(e,t,n,i,r,o,s,a,l,c,u){for(var h=r-1,f=r===0?o:[""],y=Nf(f),v=0,m=0,P=0;v<i;++v)for(var w=0,g=es(e,h+1,h=cI(m=s[v])),d=e;w<y;++w)(d=uv(m>0?f[w]+" "+g:te(g,/&\f/g,f[w])))&&(l[P++]=d);return Il(e,t,n,r===0?Lf:a,l,c,u)}function bI(e,t,n){return Il(e,t,n,lv,Cl(pI()),es(e,2,-2),0)}function Cm(e,t,n,i){return Il(e,t,n,jf,es(e,0,i),es(e,i+1,-1),i)}function Cr(e,t){for(var n="",i=Nf(e),r=0;r<i;r++)n+=t(e[r],r,e,t)||"";return n}function SI(e,t,n,i){switch(e.type){case lI:if(e.children.length)break;case aI:case jf:return e.return=e.return||e.value;case lv:return"";case cv:return e.return=e.value+"{"+Cr(e.children,i)+"}";case Lf:e.value=e.props.join(",")}return dn(n=Cr(e.children,i))?e.return=e.value+"{"+n+"}":""}function kI(e){var t=Nf(e);return function(n,i,r,o){for(var s="",a=0;a<t;a++)s+=e[a](n,i,r,o)||"";return s}}function _I(e){return function(t){t.root||(t=t.return)&&e(t)}}function PI(e){var t=Object.create(null);return function(n){return t[n]===void 0&&(t[n]=e(n)),t[n]}}var CI=function(t,n,i){for(var r=0,o=0;r=o,o=gn(),r===38&&o===12&&(n[i]=1),!ts(o);)Pt();return us(t,pt)},EI=function(t,n){var i=-1,r=44;do switch(ts(r)){case 0:r===38&&gn()===12&&(n[i]=1),t[i]+=CI(pt-1,n,i);break;case 2:t[i]+=wa(r);break;case 4:if(r===44){t[++i]=gn()===58?"&\f":"",n[i]=t[i].length;break}default:t[i]+=Cl(r)}while(r=Pt());return t},II=function(t,n){return hv(EI(fv(t),n))},Em=new WeakMap,TI=function(t){if(!(t.type!=="rule"||!t.parent||t.length<1)){for(var n=t.value,i=t.parent,r=t.column===i.column&&t.line===i.line;i.type!=="rule";)if(i=i.parent,!i)return;if(!(t.props.length===1&&n.charCodeAt(0)!==58&&!Em.get(i))&&!r){Em.set(t,!0);for(var o=[],s=II(n,o),a=i.props,l=0,c=0;l<s.length;l++)for(var u=0;u<a.length;u++,c++)t.props[c]=o[l]?s[l].replace(/&\f/g,a[u]):a[u]+" "+s[l]}}},MI=function(t){if(t.type==="decl"){var n=t.value;n.charCodeAt(0)===108&&n.charCodeAt(2)===98&&(t.return="",t.value="")}};function pv(e,t){switch(dI(e,t)){case 5103:return ee+"print-"+e+e;case 5737:case 4201:case 3177:case 3433:case 1641:case 4457:case 2921:case 5572:case 6356:case 5844:case 3191:case 6645:case 3005:case 6391:case 5879:case 5623:case 6135:case 4599:case 4855:case 4215:case 6389:case 5109:case 5365:case 5621:case 3829:return ee+e+e;case 5349:case 4246:case 4810:case 6968:case 2756:return ee+e+Za+e+Xe+e+e;case 6828:case 4268:return ee+e+Xe+e+e;case 6165:return ee+e+Xe+"flex-"+e+e;case 5187:return ee+e+te(e,/(\w+).+(:[^]+)/,ee+"box-$1$2"+Xe+"flex-$1$2")+e;case 5443:return ee+e+Xe+"flex-item-"+te(e,/flex-|-self/,"")+e;case 4675:return ee+e+Xe+"flex-line-pack"+te(e,/align-content|flex-|-self/,"")+e;case 5548:return ee+e+Xe+te(e,"shrink","negative")+e;case 5292:return ee+e+Xe+te(e,"basis","preferred-size")+e;case 6060:return ee+"box-"+te(e,"-grow","")+ee+e+Xe+te(e,"grow","positive")+e;case 4554:return ee+te(e,/([^-])(transform)/g,"$1"+ee+"$2")+e;case 6187:return te(te(te(e,/(zoom-|grab)/,ee+"$1"),/(image-set)/,ee+"$1"),e,"")+e;case 5495:case 3959:return te(e,/(image-set\([^]*)/,ee+"$1$`$1");case 4968:return te(te(e,/(.+:)(flex-)?(.*)/,ee+"box-pack:$3"+Xe+"flex-pack:$3"),/s.+-b[^;]+/,"justify")+ee+e+e;case 4095:case 3583:case 4068:case 2532:return te(e,/(.+)-inline(.+)/,ee+"$1$2")+e;case 8116:case 7059:case 5753:case 5535:case 5445:case 5701:case 4933:case 4677:case 5533:case 5789:case 5021:case 4765:if(dn(e)-1-t>6)switch(Fe(e,t+1)){case 109:if(Fe(e,t+4)!==45)break;case 102:return te(e,/(.+:)(.+)-([^]+)/,"$1"+ee+"$2-$3$1"+Za+(Fe(e,t+3)==108?"$3":"$2-$3"))+e;case 115:return~gd(e,"stretch")?pv(te(e,"stretch","fill-available"),t)+e:e}break;case 4949:if(Fe(e,t+1)!==115)break;case 6444:switch(Fe(e,dn(e)-3-(~gd(e,"!important")&&10))){case 107:return te(e,":",":"+ee)+e;case 101:return te(e,/(.+:)([^;!]+)(;|!.+)?/,"$1"+ee+(Fe(e,14)===45?"inline-":"")+"box$3$1"+ee+"$2$3$1"+Xe+"$2box$3")+e}break;case 5936:switch(Fe(e,t+11)){case 114:return ee+e+Xe+te(e,/[svh]\w+-[tblr]{2}/,"tb")+e;case 108:return ee+e+Xe+te(e,/[svh]\w+-[tblr]{2}/,"tb-rl")+e;case 45:return ee+e+Xe+te(e,/[svh]\w+-[tblr]{2}/,"lr")+e}return ee+e+Xe+e+e}return e}var OI=function(t,n,i,r){if(t.length>-1&&!t.return)switch(t.type){case jf:t.return=pv(t.value,t.length);break;case cv:return Cr([uo(t,{value:te(t.value,"@","@"+ee)})],r);case Lf:if(t.length)return hI(t.props,function(o){switch(fI(o,/(::plac\w+|:read-\w+)/)){case":read-only":case":read-write":return Cr([uo(t,{props:[te(o,/:(read-\w+)/,":"+Za+"$1")]})],r);case"::placeholder":return Cr([uo(t,{props:[te(o,/:(plac\w+)/,":"+ee+"input-$1")]}),uo(t,{props:[te(o,/:(plac\w+)/,":"+Za+"$1")]}),uo(t,{props:[te(o,/:(plac\w+)/,Xe+"input-$1")]})],r)}return""})}},DI=[OI],$I=function(t){var n=t.key;if(n==="css"){var i=document.querySelectorAll("style[data-emotion]:not([data-s])");Array.prototype.forEach.call(i,function(m){var P=m.getAttribute("data-emotion");P.indexOf(" ")!==-1&&(document.head.appendChild(m),m.setAttribute("data-s",""))})}var r=t.stylisPlugins||DI,o={},s,a=[];s=t.container||document.head,Array.prototype.forEach.call(document.querySelectorAll('style[data-emotion^="'+n+' "]'),function(m){for(var P=m.getAttribute("data-emotion").split(" "),w=1;w<P.length;w++)o[P[w]]=!0;a.push(m)});var l,c=[TI,MI];{var u,h=[SI,_I(function(m){u.insert(m)})],f=kI(c.concat(r,h)),y=function(P){return Cr(xI(P),f)};l=function(P,w,g,d){u=g,y(P?P+"{"+w.styles+"}":w.styles),d&&(v.inserted[w.name]=!0)}}var v={key:n,sheet:new sI({key:n,container:s,nonce:t.nonce,speedy:t.speedy,prepend:t.prepend,insertionPoint:t.insertionPoint}),nonce:t.nonce,inserted:o,registered:{},insert:l};return v.sheet.hydrate(a),v},mv={exports:{}},re={};/** @license React v16.13.1
...
`;function IT({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:i=qf,iterationCount:r=1}){return Cv`
...
`,Av=({className:e})=>{const{setTheme:t,theme:n}=at(),i=()=>{n==="light"?t==null||t("dark"):t==null||t("light")};return _.jsx(Gl,{"aria-label":"Theme change button",background:"transparent",border_color:"transparent",className:e,hover_background:"none",hover_shadow:"none",min_width:"0px",onClick:i,children:_.jsx(me,{height:"40px",iconId:n==="light"?"moon":"sun",viewBox:n==="light"?"0 0 45 50":"10 20 500 500",width:"40px"})})},lM=z.nav`
  display: flex;
  width: 100%;
  justify-content: end;
  text-align: center;
...
`,ru={BurgerButton:hM,MobileMenu:dM,MobileMenuPopup:fM},pM=()=>{const{theme:e}=at(),[t,n]=j.useState(!1);return _.jsxs(ru.MobileMenu,{children:[_.jsx(ru.BurgerButton,{"aria-label":"Burger menu button",onClick:()=>{n(!t)},opened:t.toString(),theme:e,children:_.jsx("span",{})}),_.jsx(ru.MobileMenuPopup,{onClick:()=>{n(!t)},opened:t.toString(),theme:e,children:_.jsxs("ul",{"aria-label":"menu",role:"menu",children:[_.jsx(ds,{cascade:!0,duration:300,triggerOnce:!0,children:$v.map((i,r)=>_.jsx("li",{role:"menuitem",children:_.jsx(ye,{color:e==="light"?b.light.color.text.primary:b.dark.color.text.primary,href:i.item_href,theme:e,children:i.item_name})},r))}),_.jsx("li",{children:_.jsx(Av,{})})]})})]})},mM=()=>{const{theme:e,width:t}=at(),[n,i]=j.useState(!1),r=bl(b.media.mobile);return j.useEffect(()=>{const o=()=>{window.scrollY>50?i(!0):i(!1)};return window.addEventListener("scroll",o),()=>window.removeEventListener("scroll",o)},[]),_.jsxs(co.Header,{scrolled:n.toString(),theme:e,children:[_.jsxs(co.HeaderContainer,{justify:"space-between",width:"100%",children:[_.jsx(co.Left,{scrolled:n.toString(),theme:e,children:e==="light"&&n?_.jsx(_m,{color:"gray"}):_.jsx(_m,{color:"white"})}),_.jsx(co.Right,{align:"center",justify:"end",theme:e,children:t<r?_.jsx(pM,{}):_.jsx(uM,{})})]}),n&&_.jsx(co.TopButton,{href:"#",theme:e,type:"button",children:_.jsx(me,{"aria-label":"Go to top",height:"100%",iconId:"arrowRight",viewBox:"-6 -2 37 35",width:"100%"})})]})},fs=z.h2`
  display: flex;
  position: relative;
  flex-direction: column;
  align-items: center;
...
`,Ks={CategoryButton:J3,ProjectWrapper:Z3,Projects:G3,ProjectsContainer:K3},Hv=z(V)`
  background-color: ${e=>e.theme==="light"?b.light.color.background.card:b.dark.color.background.card};
  position: relative;
  top: 100%;
...
`,NO={LearningCard:jO},FO=e=>{const{theme:t}=at();return _.jsx(NO.LearningCard,{align:"end",justify:"center",theme:t,children:_.jsx(me,{height:"70%",iconId:e.imageId,viewBox:e.viewBox,width:"70%"})})},BO=z(V)`
  display: flex;
  justify-content: start;
  padding: 0 30px 30px;
`,UO={Skills:BO},Wm=j.memo(({slides:e})=>{const t=e.map((n,i)=>_.jsx(FO,{imageId:n.imageId,title:n.title,viewBox:n.viewBox||"0 0 128 128"},n.category+i.toString()));return _.jsx(UO.Skills,{children:_.jsx(zO,{autoPlay:!0,autoPlayInterval:2500,disableButtonsControls:!0,infinite:!0,items:t,mouseTracking:!0,responsive:LO})})}),WO=z.section`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,GO=su.createRoot(document.getElementById("root"));GO.render(_.jsxs($b,{theme:b,children:[_.jsx(qO,{}),_.jsx(QO,{theme:b})]}));
