...
`,XE=z.span`
  ...
  background-color: ${e=>e.theme==="light"?S.light.color.background.second:S.dark.color.background.second};
`,qE=z(V)`
  background-image: ${e=>e.theme==="light"?`url(${HE})`:`url(${WE}`};
...
`;function M3({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:i=qf,iterationCount:r=1}){return Pv`
...
`;function q3(e,t,n){switch(n){case"bottom-left":return t?z3:w3;case"bottom-right":return t?L3:x3;case"down":return e?t?N3:S3:t?j3:b3;case"left":return e?t?B3:k3:t?F3:qf;case"right":return e?t?W3:C3:t?U3:_3;case"top-left":return t?H3:P3;case"top-right":return t?V3:E3;case"up":return e?t?X3:T3:t?Y3:I3;default:return t?R3:v3}}const ds=e=>{const{big:t=!1,direction:n,reverse:i=!1,...r}=e,o=j.useMemo(()=>q3(t,i,n),[t,n,i]);return _e(Ql,{keyframes:o,...r})};R`
  from {
...
`,vI=""+new URL("Photo2-my-CAZeV4c6.webp",import.meta.url).href,wI=""+new URL("map-Dja_7-Xc.svg",import.meta.url).href,xI=z.section`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,F5={LearningCard:N5},B5=e=>{const{theme:t}=at();return _.jsx(F5.LearningCard,{align:"end",justify:"center",theme:t,children:_.jsx(me,{height:"70%",iconId:e.imageId,viewBox:e.viewBox,width:"70%"})})},U5=z(V)`
  display: flex;
