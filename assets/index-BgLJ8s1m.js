...
`,$m={DesktopMenu:l3,HeaderThemeChangeButton:c3},u3=()=>{const{theme:e}=at();return _.jsxs($m.DesktopMenu,{children:[_.jsx("ul",{"aria-label":"menu",role:"menu",children:_.jsx(ds,{cascade:!0,duration:500,fraction:0,triggerOnce:!0,children:$v.map((t,n)=>_.jsx("li",{role:"menuitem",children:_.jsx(ye,{color:e==="light"?S.light.color.text.primary:S.dark.color.text.primary,href:t.item_href,theme:e,children:t.item_name})},n))})}),_.jsx($m.HeaderThemeChangeButton,{})]})},d3=z.nav`
  opacity: 0.9;
`,f3=z.div`
  display: none;
...
`,g3=""+new URL("Photo2-my-CAZeV4c6.webp",import.meta.url).href,y3=""+new URL("map-Dja_7-Xc.svg",import.meta.url).href,v3=z.section`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,w3=z(Vi)`
  ...
  padding-top: 60px;
  background-color: ${e=>e.theme==="light"?S.light.color.background.second:S.dark.color.background.second};
  background-image: url(${g3}), url(${y3});
...
`,Ki={About:v3,AboutBanner:x3,AboutBannerList:k3,AboutBannerTitle:S3,AboutContainer:w3,SocialLinksWrapper:b3},_3=()=>{const{theme:e,width:t}=at(),n=Cl(S.media.mobile),i=new Date,r=new Date(1987,6,16,14,45,0),o=new Date(2023,1,1,0,0,1),s=new Date(i.getTime()-o.getTime()).getFullYear()-1970,a=new Date(i.getTime()-r.getTime()).getFullYear()-1970;return _.jsx(Ki.About,{id:"about",theme:e,children:_.jsxs(Ki.AboutContainer,{direction:"column",theme:e,children:[t>n&&_.jsx(fs,{color:"white",theme:e,children:"About me"}),_.jsxs(Ki.AboutBanner,{align:"center",direction:"column",justify:"center",theme:e,wrap:"wrap",children:[_.jsxs(Ki.SocialLinksWrapper,{align:"center",children:[_.jsx(ye,{"aria-label":"GitHub page link",href:"https://github.com/proffery",children:_.jsx(me,{height:"50px",iconId:"gitHub",viewBox:"-90 -60 260 260",width:"50px"})}),_.jsx(ye,{"aria-label":"LinkedIn account",href:"https://www.linkedin.com/in/dmitryshamko/",children:_.jsx(me,{iconId:"linkedIn",viewBox:"-25 -12 158 158",width:"30px"})}),_.jsx(ye,{"aria-label":"Telegram link",href:"https://t.me/ShamkoDmitry",children:_.jsx(me,{iconId:"aboutTelegram",viewBox:"-4 0 35 35",width:"46px"})})]}),_.jsxs(V,{align:"flex-start",direction:"column",gap:"10px",wrap:"wrap",children:[_.jsx(Ki.AboutBannerTitle,{children:"About me:"}),_.jsxs(Ki.AboutBannerList,{theme:e,children:[_.jsx("li",{children:"I was born in Belarus"}),_.jsx("li",{children:"I’m web developer"}),_.jsxs("li",{children:["I have my interest in this field more than ",s," years"]}),_.jsxs("li",{children:["I’m ",a," years old"]}),_.jsx("li",{children:"My phone number +375256979075"})]})]})]})]})})};class hs{constructor(t=0,n="Network Error"){this.status=t,this.text=n}}const C3=()=>{if(!(typeof localStorage>"u"))return{get:e=>Promise.resolve(localStorage.getItem(e)),set:(e,t)=>Promise.resolve(localStorage.setItem(e,t)),remove:e=>Promise.resolve(localStorage.removeItem(e))}},Be={origin:"https://api.emailjs.com",blockHeadless:!1,storageProvider:C3()},Qf=e=>e?typeof e=="string"?{publicKey:e}:e.toString()==="[object Object]"?e:{}:{},P3=(e,t="https://api.emailjs.com")=>{if(!e)return;const n=Qf(e);Be.publicKey=n.publicKey,Be.blockHeadless=n.blockHeadless,Be.storageProvider=n.storageProvider,Be.blockList=n.blockList,Be.limitRate=n.limitRate,Be.origin=n.origin||t},Rv=async(e,t,n={})=>{const i=await fetch(Be.origin+e,{method:"POST",headers:n,body:t}),r=await i.text(),o=new hs(i.status,r);if(i.ok)return o;throw o},zv=(e,t,n)=>{if(!e||typeof e!="string")throw"The public key is required. Visit https://dashboard.emailjs.com/admin/account";if(!t||typeof t!="string")throw"The service ID is required. Visit https://dashboard.emailjs.com/admin";if(!n||typeof n!="string")throw"The template ID is required. Visit https://dashboard.emailjs.com/admin/templates"},E3=e=>{if(e&&e.toString()!=="[object Object]")throw"The template params have to be the object. Visit https://www.emailjs.com/docs/sdk/send/"},Lv=e=>e.webdriver||!e.languages||e.languages.length===0,jv=()=>new hs(451,"Unavailable For Headless Browser"),I3=(e,t)=>{if(!Array.isArray(e))throw"The BlockList list has to be an array";if(typeof t!="string")throw"The BlockList watchVariable has to be a string"},T3=e=>{var t;return!((t=e.list)!=null&&t.length)||!e.watchVariable},O3=(e,t)=>e instanceof FormData?e.get(t):e[t],Fv=(e,t)=>{if(T3(e))return!1;I3(e.list,e.watchVariable);const n=O3(t,e.watchVariable);return typeof n!="string"?!1:e.list.includes(n)},Nv=()=>new hs(403,"Forbidden"),M3=(e,t)=>{if(typeof e!="number"||e<0)throw"The LimitRate throttle has to be a positive number";if(t&&typeof t!="string")throw"The LimitRate ID has to be a non-empty string"},D3=async(e,t,n)=>{const i=Number(await n.get(e)||0);return t-Date.now()+i},Bv=async(e,t,n)=>{if(!t.throttle||!n)return!1;M3(t.throttle,t.id);const i=t.id||e;return await D3(i,t.throttle,n)>0?!0:(await n.set(i,Date.now().toString()),!1)},Uv=()=>new hs(429,"Too Many Requests"),$3=async(e,t,n,i)=>{const r=Qf(i),o=r.publicKey||Be.publicKey,s=r.blockHeadless||Be.blockHeadless,a=r.storageProvider||Be.storageProvider,l={...Be.blockList,...r.blockList},c={...Be.limitRate,...r.limitRate};return s&&Lv(navigator)?Promise.reject(jv()):(zv(o,e,t),E3(n),n&&Fv(l,n)?Promise.reject(Nv()):await Bv(location.pathname,c,a)?Promise.reject(Uv()):Rv("/api/v1.0/email/send",JSON.stringify({lib_version:"4.4.1",user_id:o,service_id:e,template_id:t,template_params:n}),{"Content-type":"application/json"}))},A3=e=>{if(!e||e.nodeName!=="FORM")throw"The 3rd parameter is expected to be the HTML form element or the style selector of the form"},R3=e=>typeof e=="string"?document.querySelector(e):e,z3=async(e,t,n,i)=>{const r=Qf(i),o=r.publicKey||Be.publicKey,s=r.blockHeadless||Be.blockHeadless,a=Be.storageProvider||r.storageProvider,l={...Be.blockList,...r.blockList},c={...Be.limitRate,...r.limitRate};if(s&&Lv(navigator))return Promise.reject(jv());const u=R3(n);zv(o,e,t),A3(u);const h=new FormData(u);return Fv(l,h)?Promise.reject(Nv()):await Bv(location.pathname,c,a)?Promise.reject(Uv()):(h.append("lib_version","4.4.1"),h.append("service_id",e),h.append("template_id",t),h.append("user_id",o),Rv("/api/v1.0/email/send-form",h))},L3={init:P3,send:$3,sendForm:z3,EmailJSResponseStatus:hs},j3=z.section`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,Ks={CategoryButton:ZO,ProjectWrapper:KO,Projects:QO,ProjectsContainer:GO},Hv=z(V)`
  background-color: ${e=>e.theme==="light"?S.light.color.background.card:S.dark.color.background.card};
  position: relative;
  top: 100%;
...
`,j5={LearningCard:L5},F5=e=>{const{theme:t}=at();return _.jsx(j5.LearningCard,{align:"end",justify:"center",theme:t,children:_.jsx(me,{height:"70%",iconId:e.imageId,viewBox:e.viewBox,width:"70%"})})},N5=z(V)`
  display: flex;
  justify-content: start;
  padding: 0 30px 30px;
`,B5={Skills:N5},Wm=j.memo(({slides:e})=>{const t=e.map((n,i)=>_.jsx(F5,{imageId:n.imageId,title:n.title,viewBox:n.viewBox||"0 0 128 128"},n.category+i.toString()));return _.jsx(B5.Skills,{children:_.jsx(R5,{autoPlay:!0,autoPlayInterval:2500,disableButtonsControls:!0,infinite:!0,items:t,mouseTracking:!0,responsive:z5})})}),U5=z.section`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,Q5=su.createRoot(document.getElementById("root"));Q5.render(_.jsxs($b,{theme:S,children:[_.jsx(X5,{}),_.jsx(q5,{theme:S})]}));
