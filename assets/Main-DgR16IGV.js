...
`,Z=c(x)`
  ...
  &::before {
    ...
    height: 88px;
    width: 88px;
    ${b({fMax:150,fMin:100,lineHeight:1.36,weight:600})}
...
`,K=c.img`
  ...
  object-fit: cover;
`,ee=c.h1`
  ${b({fMax:30,fMin:20,lineHeight:1.68,weight:700})}
  text-shadow: ${i=>i.theme==="light"?n.light.shadow.text:n.dark.shadow.text};
`,te=c.div`
  ${b({fMax:60,fMin:28,family:"Montserrat",lineHeight:1,weight:700})}
  text-shadow: ${i=>i.theme==="light"?n.light.shadow.text:n.dark.shadow.text};
  text-align: end;
`,ie=c(x)`
  min-width: 376px;
...
`,ne=c.p`
  text-align: left;
  ${b({fMax:20,fMin:11,lineHeight:1.5,weight:400})}
`,re=c(x)`
  gap: 26px;
  @media ${n.media.mobile} {
    gap: 16px;
...
`,oe=c(P)`
  ${b({fMax:18,fMin:12,lineHeight:1.5,weight:600})}
  max-width: 200px;
  min-height: 54px;
  border-radius: 12px;
  padding: 5px 30px;
