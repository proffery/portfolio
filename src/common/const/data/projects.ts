...
export const projects = [
  {
    ...
    projectTitle: 'Calculator. Foundations Course',
  },
  {
    ...
    projectTitle: 'Etch-a-Sketch. Foundations Course',
  },
  {
    imageUrl: Library,
    projectCategory: 'Vanilla JS',
    ...
    projectTitle: 'Library. Foundations Course',
  },
  {
    imageUrl: TicTacToe,
    projectCategory: 'Vanilla JS',
    ...
    projectTitle: 'Tic Tac Toe. Foundations Course',
  },
  {
    imageUrl: TodoList,
    projectCategory: 'Vanilla JS',
    ...
    projectTitle: 'Todo List. Foundations Course',
  },
  {
    imageUrl: WeatherApp,
    projectCategory: 'Vanilla JS',
  ...
  },
  {
    ...
    projectTitle: 'Memory Card Game. JavaScript',
  },
  {
    ...
    projectTitle: 'Photographer page: JavaScript, React-Bootstrap. Firebase',
  },
  {
    ...
    projectTitle: 'Social Network: TypeScrypt. React. Redux. Axios. Styled-components',
  },
  {
    imageUrl: FlashCards,
    projectCategory: 'React',
    ...
    projectTitle: 'Flash Cards: TypeScrypt. React. RTK Query. SCSS. Storybook',
  },
]
